export default {
  ...
  description: "",
  seo_title: "Genres — video game discovery site",
  seo_description:
    "Genres — RAWG is a video game discovery site. The most comprehensive database that is powered by personal player experiences.",
  seo_h1: "Genres",
};
